...
export default function StationList({
  ...
  return (
    <div className={`card flex flex-col ${className}`}>
      ...
      <div className="max-h-[720px] min-h-[360px] flex-1 overflow-y-auto p-2">
        {filtered.length === 0 ? (
          <EmptyState
            icon={Filter}
              ...
              return (
                <li key={station.id}>
                  <button
                    ...
                    className={[
                      'group flex w-full items-center gap-2.5 rounded-md px-2.5 py-2 text-start transition-colors',
